...
public class DataProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI_MESSAGES = Uri.parse("content://com.ramogi.xboxme.provider/messages");
	public static final Uri CONTENT_URI_PROFILE = Uri.parse("content://com.ramogi.xboxme.provider/profile");
	...
	static {
		...
		uriMatcher.addURI("com.ramogi.xboxme.provider", "messages", MESSAGES_ALLROWS);
		uriMatcher.addURI("com.ramogi.xboxme.provider", "messages/#", MESSAGES_SINGLE_ROW);
		uriMatcher.addURI("com.ramogi.xboxme.provider", "profile", PROFILE_ALLROWS);
		uriMatcher.addURI("com.ramogi.xboxme.provider", "profile/#", PROFILE_SINGLE_ROW);
	}
	...
	private static class DbHelper extends SQLiteOpenHelper {
		...
		private static final String DATABASE_NAME = "xboxme.db";
